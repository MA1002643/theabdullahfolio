...
We — as maintainers, contributors, and participants in any space tied to this
project — pledge to make every interaction a harassment-free experience for
...
- Publishing others' private information — physical or email address, social
  handles tied to a real identity, etc. — without explicit permission
  ("doxxing").
...
- **Code review feedback must be respectful.** Address the code, not the author.
  "This logic could be simpler" is fine; "this is bad code" is not.
- **Zero tolerance** for harassment, hate speech, or doxxing — first offense
  results in immediate removal from project spaces.
...
repository, issues, pull requests, discussions, and any associated
communication channel — and also applies when an individual is officially
representing the project in public spaces.

## Reporting

Report unacceptable behavior to the maintainer privately at
**team@ma.codes**.
...
**Response SLA target:** acknowledgement within **72 hours** of receipt.
...
[https://www.contributor-covenant.org/version/2/1/code_of_conduct.html][cc-2.1].
